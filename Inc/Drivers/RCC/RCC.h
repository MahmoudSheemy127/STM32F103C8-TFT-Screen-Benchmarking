...
#define RCC_SPI1_MSK_BIT_POS			(0x0000000CUL)
#define RCC_SPI2_MSK_BIT_POS			(0x0000000EUL)
#define RCC_TIM2_MSK_BIT_POS			(0x00000000UL)
...
#define _RCC_SPI1_ENABLE()			(SET_BIT(RCC->RCC_APB2ENR,RCC_SPI1_MSK_BIT_POS))
#define _RCC_SPI2_ENABLE()			(SET_BIT(RCC->RCC_APB1ENR,RCC_SPI2_MSK_BIT_POS))
#define _RCC_TIM2_ENABLE()			(SET_BIT(RCC->RCC_APB1ENR,RCC_TIM2_MSK_BIT_POS))
